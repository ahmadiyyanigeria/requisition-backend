...
namespace Application.Queries
{
    public class GetRequisitions
    {
        ...
        public record RequisitionResponse(Guid RequisitionId, string SubmitterName, string ExpenseHead, RequisitionStatus Status, DateTime RequestedDate, decimal TotalAmount, RequisitionType RequisitionType, string Department);
