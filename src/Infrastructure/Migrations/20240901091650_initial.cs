        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    notes = table.Column<string>(type: "text", nullable: false, collation: "case_insensitive"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    requisition_id = table.Column<Guid>(type: "uuid", nullable: false),
                    requisition_Number = table.Column<string>(type: "varchar(50)", nullable: false, collation: "case_insensitive"),
                    submitter_id = table.Column<Guid>(type: "uuid", nullable: false),
                    description = table.Column<string>(type: "text", nullable: false, collation: "case_insensitive"),
                    ExpenseHeadName = table.Column<string>(type: "varchar(50)", nullable: false, collation: "case_insensitive"),
                    status = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    requested_date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_expense_head",
                        column: x => x.ExpenseHeadName,
                        principalTable: "expense_head",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_requisitions_ExpenseHeadName",
                table: "requisitions",
                column: "ExpenseHeadName");
